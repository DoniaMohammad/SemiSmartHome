...
uint8 DIO_u8SetPortValue(DIO_Port_t copy_Port, uint8 copy_PortVal)
{
	...
	switch (copy_Port)
	{
	case DIO_PORTA: PORTA = copy_PortVal; break;
	case DIO_PORTB: PORTB = copy_PortVal; break;
	case DIO_PORTC: PORTC = copy_PortVal; break;
	case DIO_PORTD: PORTD = copy_PortVal; break;
	default: Local_u8ErrorState = NOK; break;
	}
